package introducao;
/*
1)Atribua valores para todas os atributos da instância Funcionário e EmpresaCliente.
2)Crie uma variável pessoa1:PessoaFisica e atribua o valor de funcionario1. 
Imprima em tela os atributos que são visíveis.
3)Crie uma variável pessoa2:PessoaJuridica e atribua o valor de empresa1. 
Imprima em tela os atributos que são visíveis.
4)Crie uma variável pessoa3:Pessoa e atribua o valor de pessoa1. 
Imprima em tela os atributos que são visíveis.
5)Crie uma variável pessoa4:Pessoa e atribua o valor de pessoa2. 
Imprima em tela os atributos que são visíveis.
6)Crie uma variável funcionario2:Funcionario e atribua o valor de pessoa3. 
Imprima em tela os atributos que são visíveis.
7)Crie uma variável empresa2:EmpresaCliente e atribua o valor de pessoa4. 
Imprima em tela os atributos que são visíveis.
*/
...
public class App7 {
    public static void main(String[] args) {
        ...
        empresa1.setNumFincionarios(10);
        ...
        //PessoaFisica - Super classe do Funcionario
       ...
       // 3)Crie uma variável pessoa2:PessoaJuridica e 
        ...
        //reflash consultar os dados de uma variável; getclass volta o tipo da variável

        //6)Crie uma variável funcionario2:Funcionario e atribua o valor de pessoa3. 
        Funcionario funcionario2; 
        funcionario2 = (Funcionario)pessoa3; //-> conversão forçada
        ...
        System.out.println(empresa2.getNumFincionarios());
