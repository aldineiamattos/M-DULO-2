...
public class Livro {
    ...
    /* Todas as inf. estão encapsuladas (private)escondidas dentro do livro.
    Public Livro(String titulo){ => Livro é o construtor 
    ctor enter -> aatalho que cria o construtor
    This.titulo = titulo; ->incluir no construtor para guardar as inf. do titulo
    Ferramenta pythontutor.com para entender o porque do this.titulo= titulo;  */
