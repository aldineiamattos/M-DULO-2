...
public class GuardaVolumes {
    ...
    public String gerarListaItens(){
        ...
        /*montadorString.append("Relatorio\n");
        for(int i=0; i< listaItens.size(); i++){
            var umItem = listaItens.get(i);
                montadorString.append("\nNome : " + umItem.getNome());
                montadorString.append("\nProprietário : " + umItem.getProprietario());
            /* Fiz da forma abaixo porque na Classe Proprietario, fiz o public String toString(){ return nome;}
            montadorString.append("\nProprietário : " + umItem.getProprietario()); 
            Sem o toString no Proprietário, ficaria:
